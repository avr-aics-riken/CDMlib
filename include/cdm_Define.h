...
,   E_CDM_ERROR_READ_DFI_NO_SLICE           = 1020 ///< DFI TimeSlice要素なし
,   E_CDM_ERROR_READ_DFI_STEP               = 1021 ///< DFI Step 読込みエラー
,   E_CDM_ERROR_READ_DFI_TIME               = 1022 ///< DFI Time 読込みエラー
,   E_CDM_ERROR_READ_DFI_NO_MINMAX          = 1023 ///< DFI MinMax要素なし
,   E_CDM_ERROR_READ_DFI_MIN                = 1024 ///< DFI Min 読込みエラー
...
,   E_CDM_ERROR_UNMATCH_NUM_OF_GUIDECELLS   = 2053 ///< WriteDataで指定するガイドセル値とDFI GuideCellの値が一致しない
